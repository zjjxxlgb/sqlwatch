  ...
  */
  ...
  for ( ; ; )
  {
    ...
    */
    ...
    if (bootstrap_error) //delete by xuliang 20151222
      break;
...
mysql_execute_command(THD *thd)
{
  ...
  char *dbtablename =new char[1024] ;; //add by xuliang 20151221
#ifdef HAVE_REPLICATION
  ...
  */
  ...
  case SQLCOM_SELECT:
  {
    ...
    res= execute_sqlcom_select(thd, all_tables);*/ //delete by xuliang 20151221
    break;
  }
case SQLCOM_PREPARE:
  {
  ...
  */
  {
    ...
    */
	...
	my_snprintf(dbtablename, first_table->db_length+2+first_table->table_name_length, "%s %s", first_table->db,
		first_table->table_name);
	fprintf(stderr, "dbtablename %s\n", dbtablename);
  ...
  case SQLCOM_RENAME_TABLE:
  {
	...
	//goto error;
      ...
      */
	  ...
	  my_snprintf(dbtablename, table->db_length+2+table->table_name_length, "%s %s", table->db,
		  table->table_name);
	  fprintf(stderr, "dbtablename %s\n", dbtablename);
  ...
  case SQLCOM_UPDATE_MULTI:
  {
...
#endif
    {
      ...
      /* res= mysql_multi_update(thd, all_tables,
                              ...
                              unit,
                              select_lex,
                              &result_obj);*/ //delete by xuliang20151222
      if (result_obj)
      {
...
create_sp_error:
  ...
  case SQLCOM_GET_DIAGNOSTICS:
   ...
   // res= lex->m_sql_cmd->execute(thd);//delete by xuliang20151221
    break;
